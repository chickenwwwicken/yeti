...
Expected matches: ['bandwidth', 'leverage', 'synergy']
Actual matches: ['bandwidth', 'leverage', 'synergy']
Pass 
...
Expected matches: ['back', 'base', 'circle', 'touch']
Actual matches: ['back', 'base', 'circle', 'touch']
Pass 
...
Expected matches: ['innovate', 'pivot', 'scalable']
Actual matches: ['innovate', 'pivot', 'scalable']
Pass 
