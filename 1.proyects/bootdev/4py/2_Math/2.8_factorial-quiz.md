Again, the [factorial](https://en.wikipedia.org/wiki/Factorial) of a positive integer `n`, written `n!`, is the product of all positive integers less than and equal to `n`.
